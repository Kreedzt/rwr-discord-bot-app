...
const { Client, GatewayIntentBits, REST, SlashCommandBuilder, Routes } = discord;
...
const commands = [
	...
	new SlashCommandBuilder().setName('servers').setDescription('Replies with all server status!'),
